...
let cachedOrigin = "https://headers-hazardous-assessing-counting.trycloudflare.com";
let lastFetchTime = 0; // Force immediate refresh
...
export default {
  async fetch(request, env, ctx) {
    ...
    const apiExactPaths = ["/inference", "/telemetry", "/tts", "/speech", "/health", "/models", "/backends", "/register_tunnel", "/benchmark", "/compress", "/decompress", "/acc", "/acc/info", "/acc/status", "/acc/control", "/images/compress", "/image/compress", "/images/info", "/image/info", "/compress/image", "/info/image", "/info/images"];
